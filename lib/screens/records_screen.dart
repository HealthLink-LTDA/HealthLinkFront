              ...
              child: Column(
                ...
                children: [
                  TextFormField(
                    ...
                    onChanged: (value) => setStateDialog(() => _selectedPatientId = value),
                    validator: (value) {
                  ...
                  TextFormField(
                    ...
                    onChanged: (value) => setStateDialog(() => _selectedDoctorId = value),
                    validator: (value) {
                      if (value == null || value.isEmpty) {
                  ...
                  Slider(
                    ...
                    divisions: 3,
                    label: '$_neurologico',
                    onChanged: (value) => setStateDialog(() => _neurologico = value.toInt()),
                  ),
                  const Text(
                  ...
                  Slider(
                    ...
                    onChanged: (value) => setStateDialog(() => _cardioVascular = value.toInt()),
                  ),
                  const Text(
                  ...
                  Slider(
                    ...
                    divisions: 3,
                    label: '$_respiratorio',
                    onChanged: (value) => setStateDialog(() => _respiratorio = value.toInt()),
                  ),
                  CheckboxListTile(
